...
function compile() {
  ...
  if [[ $RA == "sora" ]]; then
    echo "ld *.o $SORA_LIBC/lib/crt1.o $SORA_LIBC/lib/crti.o $SORA_LIBC/lib/crtn.o -dynamic-linker $SORA_LIBC/syslib/ld-musl-aarch64.so.1 -L$SORA_LIBC/lib -lc -o $exe_name"
    ld *.o $SORA_LIBC/lib/crt1.o $SORA_LIBC/lib/crti.o $SORA_LIBC/lib/crtn.o -dynamic-linker $SORA_LIBC/syslib/ld-musl-aarch64.so.1 -L$SORA_LIBC/lib -lc -o $exe_name 
  else
